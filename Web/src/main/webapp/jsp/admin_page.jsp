                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <c:forEach items="${usersList}" varStatus="сounter">
                        <tr class="active">
                            ...
                            <td align="center" style="border-color: #8381eb">${usersList[сounter.count-1].firstName}</td>
            ...
            <div class="col-md-10 col-md-offset-0">
                <table class="table table-condensed table-bordered" style="vertical-align: middle">
                    <tr class="active">
                        ...
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.order.start.rent"/></td>
                    ...
                    <c:forEach items="${ordersList}" varStatus="сounter">
                        <tr class="active">
                            ...
                            <td align="center" style="border-color: #8381eb">${ordersList[сounter.count-1].startRent}</td>
        ...
        <div class="col-md-4">
            <div class="col-md-10 col-md-offset-0">
                <table class="table table-condensed table-bordered">
                    <tr class="active">
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.number"/></td>
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.rent.type"/></td>
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.rent.price"/></td>
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.rent.city"/></td>
                    ...
                    <c:forEach items="${bikesList}" varStatus="сounter" end="6">
                        <tr class="active">
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${bikesList[сounter.count-1].id}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${bikesList[сounter.count-1].type}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${bikesList[сounter.count-1].pricePerHour}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${bikesList[сounter.count-1].city}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${bikesList[сounter.count-1].location}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb"><img src="data:image/jpeg;base64,${bikesList[сounter.count-1].picture}"/>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
