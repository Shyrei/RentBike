        ...
        <c:forEach items="${bikesList}" varStatus="сounter">
            <tr>
                ...
                <c:if test="${empty user or (not empty user and user.roleId > 2)}">
                    <td align="center" style="vertical-align: middle; border-color: #dae5ff">${bikesList[сounter.count-1].id}</td>
                </c:if>
                ...
                <td align="center" style="vertical-align: middle; border-color: #dae5ff">${bikesList[сounter.count-1].type}</td>
                <td align="center" style="vertical-align: middle; border-color: #dae5ff">${bikesList[сounter.count-1].pricePerHour}</td>
                <td align="center" style="vertical-align: middle; border-color: #dae5ff">${bikesList[сounter.count-1].city}</td>
                <td align="center" style="vertical-align: middle; border-color: #dae5ff">${bikesList[сounter.count-1].location}</td>
                <td align="center" style="vertical-align: middle; border-color: #dae5ff"><img src="data:image/jpeg;base64,${bikesList[сounter.count-1].picture}"/>
                </td>
            </tr>
        </c:forEach>
    </table>
